    ...
    * */
    ...
    public void deposit(double amount) throws Exception {
        try {
            ...
            balance += amount;
            System.out.println("Amount " + amount + " succefully deposited."); //logging
        } catch (Exception e) {
    ...
    /**
     * Withdraws an amount of moeny from the {@link Account}
    ...
    public void withdraw(double amount, String ssn) throws Exception {
        try {
            ...
            if (amount < 0) {
                throw new Exception("Amount " + amount + " must not be negative.");
            }

            balance =- amount;
            System.out.println("Amount " + amount + " succefully withdrawn."); //logging
    ...
    public double getAccountBalance() {
        System.out.println("The account was returned.");    //logging
        return getBalance();
    }
